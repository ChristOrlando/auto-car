...
export default function SelectVehicleType() {
  ...
  return (
    <div ref={ref} className="relative flex flex-col gap-2 md:gap-3">
      ...
      >
        {t("contact-us.form.vehicle-type.label")}
      </label>
      <div
        className={clsx(
        ...
        <div className="flex justify-between items-center gap-x-2 w-full">
          {currentData ? (
            ...
            <span className="text-input-placeholder">
              {t("contact-us.form.vehicle-type.placeholder")}
            </span>
          )}
...
const datas = [
  {
    id: 1,
    value: "Véhicules de transport de personnel",
  },
  {
    id: 2,
    value: "Véhicules de transport de marchandises ou de matériaux",
  },
  {
    id: 3,
    value: "Autres types de véhicules concernés",
  },
];
